...
React로 웹 화면을 만드는 개발자입니다.
게임 UI와 웹사이트를 만들면서 프론트엔드에 관심을 갖게 됐고, 실무에서는 화면 구현과 API 연동 검수 과정에서 나온 오류 수정하고 경험 했습니다.

화면을 보기 좋게 만드는 것 뿐 아니라 사용자가 조작했을 때 어떻게 동작하는지도 신경 쓰고 있습니다. 다른사람이 코드 봤을 때 이해하고 수정하기 쉬운 구조를 만들고 고민 합니다.
---
